 ...
 * @author aluno
 */
public class SubtracaoComVirgula {

    public SubtracaoComVirgula() {
        ...
        System.out.println("A subtracao do primeiro numero com o segundo numero e: " + soma);
    }

    public static void main(String[] args) {
        new SubtracaoComVirgula();
    }
